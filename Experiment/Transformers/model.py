...
class InputEmbeddings(nn.Module):
    ...
    def __init__(self, d_model: int, vocab_size: int) -> None:
        super().__init__()
        self.d_model = d_model # model Dimetion
        self.vocab_size = vocab_size # input Word Size 
...
class Transformer(nn.Module):
    ...
    def forward(self, src_input, tgt_input, src_mask=None, tgt_mask=None):
        ...
        decoder_output = self.decode(encoder_output, src_mask, tgt_input, tgt_mask)
...
# src_seq_len = 20        # length of source sequences
# tgt_seq_len = 20        # length of target sequences
...
# src_input = torch.randint(0, src_vocab_size, (batch_size, src_seq_len))  # source input
# tgt_input = torch.randint(0, tgt_vocab_size, (batch_size, tgt_seq_len))  # target input
